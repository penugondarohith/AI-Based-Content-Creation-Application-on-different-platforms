...
export default function GeneratePage() { return <div className="mx-auto max-w-[1500px] px-5 py-8 lg:px-8"><CreateProjectHeader /><ProjectStepper activeStep={5} /><div className="mt-8"><ContentStudioWorkspace /></div></div>; }