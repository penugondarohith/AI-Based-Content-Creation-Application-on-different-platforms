...
export interface GeneratedContent { id: string; projectId: string; calendarPostId: string; postNumber: number; status: GeneratedContentStatus; content: GeneratedPostContent; generationContext: GenerationContext; qualityReport?: ContentQualityReport; createdAt: string; updatedAt: string; }